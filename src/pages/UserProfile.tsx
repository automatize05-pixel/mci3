    ...
    <AppLayout>
      <div className="container mx-auto px-4 py-6 max-w-3xl">
        ...
        <div className="bg-card rounded-2xl border border-border shadow-card overflow-hidden mb-6">
          {/* Cover gradient */}
          <div className="h-32 sm:h-36 gradient-warm relative" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                  <div className="text-center sm:text-left flex-1 min-w-0">
                    <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-1">
                      <h1 className="text-2xl sm:text-3xl font-black font-display text-foreground leading-tight">{displayName}</h1>
                      {isAdmin && (
                        <div className="shrink-0 text-[#1d9bf0] flex items-center">
                      ...
                      {isChef && (
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-chef text-white text-[10px] font-bold uppercase tracking-widest shadow-sm">
                          <ChefHat className="h-3 w-3 shadow-none" /> Chef
                        </span>
                      )}
                    </div>
                    <p className="text-base text-muted-foreground font-semibold">{displayUsername}</p>
                  </div>

                  {/* Actions */}
                  <div className="flex items-center justify-center sm:justify-end gap-2 shrink-0 pb-1 w-full sm:w-auto">
                    {!isOwnProfile ? (
                      <>
                      ...
                      <Link to="/settings" className="w-full sm:w-auto">
                        <Button variant="outline" className="rounded-xl w-full sm:w-auto font-bold px-6 h-10 border-2 hover:bg-muted/50" size="sm">Editar Perfil</Button>
                      </Link>
                    )}
                    <Button variant="outline" className="rounded-xl w-10 h-10 p-0 border-2 hover:bg-muted/50 focus:scale-95 transition-transform" size="sm" onClick={() => {
